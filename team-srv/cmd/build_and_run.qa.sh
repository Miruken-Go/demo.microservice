...
export OpenApi__Scopes__0__Name='https://teamsrvidentityqa.onmicrosoft.com/teamsrv/Groups'
export OpenApi__Scopes__0__Description='Groups to which the user belongs.'
export OpenApi__Scopes__1__Name='https://teamsrvidentityqa.onmicrosoft.com/teamsrv/Roles'
export OpenApi__Scopes__1__Description='Roles to which the user belongs.'
export OpenApi__Scopes__2__Name='https://teamsrvidentityqa.onmicrosoft.com/teamsrv/Entitlements'
