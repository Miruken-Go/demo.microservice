...
require (
	...
	github.com/miruken-go/demo.microservice/team v0.6.0-alpha.10
	github.com/miruken-go/miruken v0.30.86
...
require (
	...
	github.com/miruken-go/demo.microservice/team-api v0.6.0-alpha.5 // indirect
