...
require (
	...
	github.com/miruken-go/demo.microservice/team v0.4.0-alpha.18
	github.com/miruken-go/miruken v0.30.83
...
require (
	...
	github.com/miruken-go/demo.microservice/team-api v0.4.0-alpha.4 // indirect
