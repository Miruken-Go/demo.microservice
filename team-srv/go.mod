...
require (
	...
	github.com/miruken-go/demo.microservice/team v0.2.70
	github.com/miruken-go/miruken v0.30.82
...
require (
	...
	github.com/miruken-go/demo.microservice/team-api v0.3.0-alpha.10 // indirect
