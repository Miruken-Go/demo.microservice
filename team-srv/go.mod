...
require (
	...
	github.com/miruken-go/demo.microservice/team v0.6.0-alpha.229
	github.com/miruken-go/miruken v0.30.91
...
require (
	...
	github.com/miruken-go/demo.microservice/team-api v0.6.0-alpha.128 // indirect
