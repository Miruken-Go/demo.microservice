...
require (
	...
	github.com/miruken-go/demo.microservice/team v0.8.0-alpha.16
	github.com/miruken-go/miruken v0.30.99
...
require (
	...
	github.com/miruken-go/demo.microservice/team-api v0.8.0-alpha.9 // indirect
